...
parser.add_argument('--txt_path',             type=str,   help='path to test filelist',   required=True)
...
if __name__ == '__main__':
    ...
    if args.split == 'kitti':
        ...
        num_samples = 697
        test_files = read_text_lines(args.txt_path)#('/data1/pilzer/monodepth-GAN/utils/filenames/eigen_test_files_png.txt')
