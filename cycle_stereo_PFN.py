...
class Model_cycle_stereo_PFN(object):
    """Model_cycle_stereo_PFN"""
    ...
    def build(self):
        with slim.arg_scope([slim.conv2d, slim.conv2d_transpose], activation_fn=tf.nn.elu):
            ...
            with tf.variable_scope('model'):
                # ENCODERS
                self.skip1b_r2l, self.skip2b_r2l, self.skip3b_r2l, self.skip4b_r2l, self.skip5b_r2l, self.conv5b_r2l = self.encoder(self.right_est[0], direction='right', name='enc', reuse=True)
                self.skip1b_l2r, self.skip2b_l2r, self.skip3b_l2r, self.skip4b_l2r, self.skip5b_l2r, self.conv5b_l2r = self.encoder(self.left_est[0], direction='left', name='enc', reuse=True)
                # DISP-4
                self.conv4b_r2l, self.disp4b_r2l = self.dec4(self.skip3b_r2l, self.skip4b_r2l, self.skip5b_r2l, self.conv5b_r2l,  direction='right', name='dec4r2l', reuse=True)
                self.conv4b_l2r, self.disp4b_l2r = self.dec4(self.skip3b_l2r, self.skip4b_l2r, self.skip5b_l2r, self.conv5b_l2r,  direction='right', name='dec4l2r', reuse=True)
                self.disp4b_r2l.set_shape([self.batch_size, self.size_H/8, self.size_W/8, 1])
                self.disp4b_l2r.set_shape([self.batch_size, self.size_H/8, self.size_W/8, 1])
                # DISP-4 WARP AND CONC
                if self.fuse_feat:
                    self.r2l_disp4b_l2r = self.generate_image_left(self.disp4b_l2r, self.disp4b_r2l)
                    self.r2l_conv4b_l2r = self.generate_image_left(self.conv4b_l2r, self.disp4b_r2l)
                    self.l2r_disp4b_r2l = self.generate_image_right(self.disp4b_r2l, self.disp4b_l2r)
                    self.l2r_conv4b_r2l = self.generate_image_right(self.conv4b_r2l, self.disp4b_l2r)
                    self.conc_disp4b_r2l = tf.concat([self.disp4b_r2l, self.r2l_disp4b_l2r, self.r2l_conv4b_l2r], 3)
                    self.conc_disp4b_l2r = tf.concat([self.disp4b_l2r, self.l2r_disp4b_r2l, self.l2r_conv4b_r2l], 3)
                    self.conc_disp4b_r2l.set_shape([self.batch_size, self.size_H/8, self.size_W/8, 130])
                    self.conc_disp4b_l2r.set_shape([self.batch_size, self.size_H/8, self.size_W/8, 130])
                else:
                    self.r2l_disp4b_l2r = self.generate_image_left(self.disp4b_l2r, self.disp4b_r2l)
                    self.l2r_disp4b_r2l = self.generate_image_right(self.disp4b_r2l, self.disp4b_l2r)
                    self.conc_disp4b_r2l = tf.concat([self.disp4b_r2l, self.r2l_disp4b_l2r], 3)
                    self.conc_disp4b_l2r = tf.concat([self.disp4b_l2r, self.l2r_disp4b_r2l], 3)
                    self.conc_disp4b_r2l.set_shape([self.batch_size, self.size_H/8, self.size_W/8, 2])
                    self.conc_disp4b_l2r.set_shape([self.batch_size, self.size_H/8, self.size_W/8, 2])
                # DISP-3
                self.conv3b_r2l, self.disp3b_r2l = self.dec3(self.skip2b_r2l, self.conv4b_r2l, self.conc_disp4b_r2l,  direction='right', name='dec3r2l', reuse=True)
                self.conv3b_l2r, self.disp3b_l2r = self.dec3(self.skip2b_l2r, self.conv4b_l2r, self.conc_disp4b_l2r,  direction='right', name='dec3l2r', reuse=True)
                self.disp3b_r2l.set_shape([self.batch_size, self.size_H/4, self.size_W/4, 1])
                self.disp3b_l2r.set_shape([self.batch_size, self.size_H/4, self.size_W/4, 1])
                # DISP-3 WARP AND CONC
                if self.fuse_feat:
                    self.r2l_disp3b_l2r = self.generate_image_left(self.disp3b_l2r, self.disp3b_r2l)
                    self.r2l_conv3b_l2r = self.generate_image_left(self.conv3b_l2r, self.disp3b_r2l)
                    self.l2r_disp3b_r2l = self.generate_image_right(self.disp3b_r2l, self.disp3b_l2r)
                    self.l2r_conv3b_r2l = self.generate_image_right(self.conv3b_r2l, self.disp3b_l2r)
                    self.conc_disp3b_r2l = tf.concat([self.disp3b_r2l, self.r2l_disp3b_l2r, self.r2l_conv3b_l2r], 3)
                    self.conc_disp3b_l2r = tf.concat([self.disp3b_l2r, self.l2r_disp3b_r2l, self.l2r_conv3b_r2l], 3)
                    self.conc_disp3b_r2l.set_shape([self.batch_size, self.size_H/4, self.size_W/4, 66])
                    self.conc_disp3b_l2r.set_shape([self.batch_size, self.size_H/4, self.size_W/4, 66])
                else:
                    self.r2l_disp3b_l2r = self.generate_image_left(self.disp3b_l2r, self.disp3b_r2l)
                    self.l2r_disp3b_r2l = self.generate_image_right(self.disp3b_r2l, self.disp3b_l2r)
                    self.conc_disp3b_r2l = tf.concat([self.disp3b_r2l, self.r2l_disp3b_l2r], 3)
                    self.conc_disp3b_l2r = tf.concat([self.disp3b_l2r, self.l2r_disp3b_r2l], 3)
                    self.conc_disp3b_r2l.set_shape([self.batch_size, self.size_H/4, self.size_W/4, 2])
                    self.conc_disp3b_l2r.set_shape([self.batch_size, self.size_H/4, self.size_W/4, 2])
                # DISP-2
                self.conv2b_r2l, self.disp2b_r2l = self.dec2(self.skip1b_r2l, self.conv3b_r2l, self.conc_disp3b_r2l,  direction='right', name='dec2r2l', reuse=True)
                self.conv2b_l2r, self.disp2b_l2r = self.dec2(self.skip1b_l2r, self.conv3b_l2r, self.conc_disp3b_l2r,  direction='right', name='dec2l2r', reuse=True)
                self.disp2b_r2l.set_shape([self.batch_size, self.size_H/2, self.size_W/2, 1])
                self.disp2b_l2r.set_shape([self.batch_size, self.size_H/2, self.size_W/2, 1])
                # DISP-2 WARP AND CONC
                if self.fuse_feat:
                    self.r2l_disp2b_l2r = self.generate_image_left(self.disp2b_l2r, self.disp2b_r2l)
                    self.r2l_conv2b_l2r = self.generate_image_left(self.conv2b_l2r, self.disp2b_r2l)
                    self.l2r_disp2b_r2l = self.generate_image_right(self.disp2b_r2l, self.disp2b_l2r)
                    self.l2r_conv2b_r2l = self.generate_image_right(self.conv2b_r2l, self.disp2b_l2r)
                    self.conc_disp2b_r2l = tf.concat([self.disp2b_r2l, self.r2l_disp2b_l2r, self.r2l_conv2b_l2r], 3)
                    self.conc_disp2b_l2r = tf.concat([self.disp2b_l2r, self.l2r_disp2b_r2l, self.l2r_conv2b_r2l], 3)
                    self.conc_disp2b_r2l.set_shape([self.batch_size, self.size_H/2, self.size_W/2, 34])
                    self.conc_disp2b_l2r.set_shape([self.batch_size, self.size_H/2, self.size_W/2, 34])
                else:
                    self.r2l_disp2b_l2r = self.generate_image_left(self.disp2b_l2r, self.disp2b_r2l)
                    self.l2r_disp2b_r2l = self.generate_image_right(self.disp2b_r2l, self.disp2b_l2r)
                    self.conc_disp2b_r2l = tf.concat([self.disp2b_r2l, self.r2l_disp2b_l2r], 3)
                    self.conc_disp2b_l2r = tf.concat([self.disp2b_l2r, self.l2r_disp2b_r2l], 3)
                    self.conc_disp2b_r2l.set_shape([self.batch_size, self.size_H/2, self.size_W/2, 2])
                    self.conc_disp2b_l2r.set_shape([self.batch_size, self.size_H/2, self.size_W/2, 2])
                # DISP-1
                self.disp1b_r2l = self.dec1(self.conv2b_r2l, self.conc_disp2b_r2l,  direction='right', name='dec1r2l', reuse=True)
                self.disp1b_l2r = self.dec1(self.conv2b_l2r, self.conc_disp2b_l2r,  direction='right', name='dec1l2r', reuse=True)
                self.disp1b_r2l.set_shape([self.batch_size, self.size_H, self.size_W, 1])
                self.disp1b_l2r.set_shape([self.batch_size, self.size_H, self.size_W, 1])
            ...
            with tf.variable_scope('disparities'):
                ...
                self.disp_right_est[3].set_shape([self.batch_size, self.size_H/8, self.size_W/8, 1])
                # SECOND HALF
                self.disp_leftb_est  = [self.disp1b_r2l, self.disp2b_r2l, self.disp3b_r2l, self.disp4b_r2l]
                self.disp_leftb_est[0].set_shape([self.batch_size, self.size_H, self.size_W, 1])
                self.disp_leftb_est[1].set_shape([self.batch_size, self.size_H/2, self.size_W/2, 1])
                self.disp_leftb_est[2].set_shape([self.batch_size, self.size_H/4, self.size_W/4, 1])
                self.disp_leftb_est[3].set_shape([self.batch_size, self.size_H/8, self.size_W/8, 1])
                self.disp_rightb_est  = [self.disp1b_l2r, self.disp2b_l2r, self.disp3b_l2r, self.disp4b_l2r]
                self.disp_rightb_est[0].set_shape([self.batch_size, self.size_H, self.size_W, 1])
                self.disp_rightb_est[1].set_shape([self.batch_size, self.size_H/2, self.size_W/2, 1])
                self.disp_rightb_est[2].set_shape([self.batch_size, self.size_H/4, self.size_W/4, 1])
                self.disp_rightb_est[3].set_shape([self.batch_size, self.size_H/8, self.size_W/8, 1])

            # GENERATE IMAGES
            with tf.variable_scope('images'):
                self.leftb_est = [self.generate_image_left(self.right_est[i], self.disp_leftb_est[i]) for i in range(4)]
                self.leftb_est[0].set_shape([self.batch_size, self.size_H, self.size_W, 3])
                self.rightb_est = [self.generate_image_right(self.left_est[i], self.disp_rightb_est[i]) for i in range(4)]
                self.rightb_est[0].set_shape([self.batch_size, self.size_H, self.size_W, 3])
            ...
            if self.use_discr:
                with tf.variable_scope('model'):
                    ...
                    self.D_leftb_fake = self.discriminator(self.leftb_est[0], self.options, reuse=True, name="discriminatorL")
                    ...
                    self.D_rightb_fake = self.discriminator(self.rightb_est[0], self.options, reuse=True, name="discriminatorR")
    ...
    def build_losses(self):
        with tf.variable_scope('losses', reuse=self.reuse_variables):
            ...
            self.l1_leftb = [tf.abs(self.leftb_est[i] - self.left_pyramid[i]) for i in range(4)]
            self.l1_rightb = [tf.abs(self.rightb_est[i] - self.right_pyramid[i]) for i in range(4)]
            self.l1_reconstruction_loss_leftb = [tf.reduce_mean(l) for l in self.l1_leftb]
            self.l1_reconstruction_loss_rightb = [tf.reduce_mean(l) for l in self.l1_rightb]
            ...
            self.ssim_leftb = [self.SSIM(self.leftb_est[i], self.left_pyramid[i]) for i in range(4)]
            self.ssim_loss_leftb = [tf.reduce_mean(s) for s in self.ssim_leftb]
            self.ssim_rightb = [self.SSIM(self.rightb_est[i], self.right_pyramid[i]) for i in range(4)]
            self.ssim_loss_rightb = [tf.reduce_mean(s) for s in self.ssim_rightb]
            ...
            self.image_loss_leftb = [self.params.alpha_image_loss * self.ssim_loss_leftb[i] + (1 - self.params.alpha_image_loss) * self.l1_reconstruction_loss_leftb[i] for i in range(4)]
            self.image_loss_rightb = [self.params.alpha_image_loss * self.ssim_loss_rightb[i] + (1 - self.params.alpha_image_loss) * self.l1_reconstruction_loss_rightb[i] for i in range(4)]
            self.cycle_loss = tf.add_n(self.image_loss_left + self.image_loss_right)
            ...
            if self.use_discr:
                ...
                self.d_loss_leftb_fake = self.criterionGAN(self.D_leftb_fake, tf.zeros_like(self.D_leftb_fake))
                self.d_loss_left = (2*self.d_loss_left_real + self.d_loss_left_fake + self.d_loss_leftb_fake) / 4
                ...
                self.d_loss_rightb_fake = self.criterionGAN(self.D_rightb_fake, tf.zeros_like(self.D_rightb_fake))
                self.d_loss_right = (2*self.d_loss_right_real + self.d_loss_right_fake + self.d_loss_rightb_fake) / 2
            ...
            self.total_loss = self.image_loss + (self.params.lr_loss_weight * self.lr_loss) + (0.1 * self.cycle_loss) - (0.0001 * self.d_loss_fake)
